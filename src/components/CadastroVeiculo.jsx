          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input value={placa} onChange={e => setPlaca(e.target.value)} className="mt-1 block w-full border rounded p-2" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input value={cor} onChange={e => setCor(e.target.value)} className="mt-1 block w-full border rounded p-2" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input value={motorizacao} onChange={e => setMotorizacao(e.target.value)} className="mt-1 block w-full border rounded p-2" />
              </div>
              <div>
            ...
            <div className="mt-6 flex space-x-4">
              <button onClick={handleSubmit} className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">{veiculoId ? 'Salvar' : 'Cadastrar'}</button>
