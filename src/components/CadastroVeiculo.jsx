  ...
  async function handleSubmit() {
    ...
    try {
      if (veiculoId) {
        ...
        // _IMPORTANTE:_ assumir que o back já retorna o objeto:
        // { placa, marca_veiculo, modelo_veiculo, nome, telefone, id_veiculo, id_cliente_veiculo, ... }
        const data = await res.json();
        console.log("Veículo criado:", data);
        
        alert("Veículo cadastrado com sucesso.");

        // Chama onCreated passando TODO o objeto “completo”:
        ...
        <div className="bg-white p-6 rounded-lg w-full max-w-2xl max-h-[90vh] overflow-auto">
          ...
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-xl font-bold">
              {veiculoId ? "Editar Veículo" : "Cadastrar Veículo"}
            </h4>
            <button
              onClick={onClose}
          ...
          <div className="space-y-4">
            {/* Campos do formulário (PLACA, MARCA, MODELO, ... ) */}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  value={motorizacao}
                  onChange={(e) => setMotorizacao(e.target.value.toUpperCase())}
                  className="mt-1 block w-full border rounded p-2 uppercase"
                />
              </div>
              <div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-60">
          <div className="bg-white p-6 rounded-lg w-full max-w-md max-h-[80vh] overflow-auto">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                onClick={() => setBuscaClienteOpen(false)}
            ...
            {clienteNaoEncontrado && (
              <p className="text-red-600 mb-4">Nenhum cliente encontrado.</p>
            )}
                  ...
                  {clientesResultados.map((c) => (
                    <tr key={c.id_cliente} className="hover:bg-gray-50">
                      ...
                      <td className="border p-2">
                        <button
                          onClick={() => selecionarCliente(c.id_cliente, c.nome)}
